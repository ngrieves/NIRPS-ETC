...
def read_table_script():
	file_name='nirps_etc_targets.dat'
	TABLE_ARCHIVE=open(file_name,'rt')
	PARAMETERS=TABLE_ARCHIVE.readlines()

	i=0

	while i < len(PARAMETERS):

		parameters=PARAMETERS[i].split()
		id_star=parameters[0]
		st=parameters[1]
		obs_mode=parameters[2]
		seeing=float(parameters[3])
		airmass=float(parameters[4])
		H=float(parameters[5])
		t_exp=float(parameters[6])

		NIRPS_ETC(id_star,st,obs_mode,seeing,airmass,H,t_exp)

		i=i+1
		# silent=1	

	return (id_star,st,obs_mode,seeing,airmass,H,t_exp)
		
def NIRPS_ETC(id_star,st,obs_mode,seeing,airmass,H,t_exp):
	...
	def calc_delta_rv(st,obs_mode,sn_h,SN_px,SN_pxY,SN_pxJ,SN_pxH,SN_pxHh):
		...
		if y1_cond2==9999:
################			print("It's not possible to calculate de RV precision for this star!")
			delta_RV1_3='---'
			delta_RV1_2='---'
			delta_RV5_3='---'
			delta_RV5_2='---'
			delta_RV10_3='---'
			delta_RV10_2='---'
			print("%10s %8.1f %8.1f %8.1f %8.1f %8.1f %8s %8s %8s %8s %8s %8s"%(id_star,SN_px,SN_pxY,SN_pxJ,SN_pxH,SN_pxHh,delta_RV1_3,delta_RV1_2,delta_RV5_3,delta_RV5_2,delta_RV10_3,delta_RV10_2))
			# print("\n###################################################")
			...
			print("%10s %8.1f %8.1f %8.1f %8.1f %8.1f %8.1f %8.1f %8.1f %8.1f %8.1f %8.1f"%(id_star,SN_px,SN_pxY,SN_pxJ,SN_pxH,SN_pxHh,delta_RV1_3,delta_RV1_2,delta_RV5_3,delta_RV5_2,delta_RV10_3,delta_RV10_2))

#		return (delta_RV1_3,delta_RV1_2,delta_RV5_3,delta_RV5_2,delta_RV10_3,delta_RV10_2)
...
############			print("Faint star. Better to observe in HE mode.")
			# print("\n#######################################################")
...
#	print("%5.1f %5.1f %5.1f %5.1f %5.1f %5.1f %5.1f %5.1f %5.1f %5.1f %5.1f"%(delta_RV1_3,delta_RV1_2,delta_RV5_3,delta_RV5_2,delta_RV10_3,delta_RV10_2,SN_pxl/68,SN_pxl_Y/mean_pxl_Y,SN_pxl_J/mean_pxl_J,SN_pxl_H/mean_pxl_H,SNR_pxl_H))
	#print("%5.1f %5.1f %5.1f %5.1f %5.1f"%(SN_pxl/68,SN_pxl_Y/mean_pxl_Y,SN_pxl_J/mean_pxl_J,SN_pxl_H/mean_pxl_H,SNR_pxl_H))
	# if silent == 0:
	# 	print ("-----------------------------------------------------------------")
	...
	SN_px=SN_pxl/68
	SN_pxY=SN_pxl_Y/mean_pxl_Y
	SN_pxJ=SN_pxl_J/mean_pxl_J
	SN_pxH=SN_pxl_H/mean_pxl_H
	SN_pxHh=SNR_pxl_H
	calc_delta_rv(st,obs_mode,sn_h,SN_px,SN_pxY,SN_pxJ,SN_pxH,SN_pxHh)
...
print ("================================================================================================================")
print ("ID-Star	       <sn>     <sn>y    <sn>j    <sn>h    <sn>h'  RV_min1  RV_max1  RV_min5  RV_max5  RV_min10 RV_max10")
print ("               (px)     (px)     (px)     (px)	    (px)    (m/s)    (m/s)    (m/s)    (m/s)    (m/s)    (m/s)  ") 
print ("----------------------------------------------------------------------------------------------------------------")

(id_star,st,obs_mode,seeing,airmass,H,t_exp)=read_table_script()
print ("================================================================================================================")
